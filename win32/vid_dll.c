...
vidmode_t vid_modes[] =
{
	...
	{ "Mode 0: 426x240",   426, 240,   0 },
	{ "Mode 1: 640x360",   640, 360,   1 },
	{ "Mode 2: 960x540",   960, 540,   2 },
	{ "Mode 3: 1024x576",  1024, 576,  3 },
	{ "Mode 4: 1280x720",  1280, 720,  4 },
	{ "Mode 5: 1600x900",  1600, 900,  5 },
	{ "Mode 6: 1920x1080", 1920, 1080, 6 },
	{ "Mode 7: 2560x1440", 2560, 1440, 7 },
	{ "Mode 8: 3200x1800", 3200, 1800, 8 },
	{ "Mode 9: 3840x2160", 3840, 2160, 9 }
};
...
//PGM
	...
	if(vid_ref)
	{
		...
		else if (!strcmp(vid_ref->string, "dx11rg"))
			vidref_val = VIDREF_DX11RG;
	}
//PGM
//======
